...
splash_img = pygame.transform.scale(pygame.image.load('Assets/splash_logo.png'),
			 (1.6*WIDTH,HEIGHT))
bounce_img = pygame.transform.scale(pygame.image.load('Assets/menu_logo.png'),(0.96*WIDTH, 0.5*HEIGHT))
game_lost_img = pygame.transform.scale(pygame.image.load('Assets/lose.png'), (0.75*WIDTH, 0.5*HEIGHT))
...
play_img = pygame.transform.scale(pygame.image.load('Assets/play.png'), (0.3*WIDTH, 0.1*HEIGHT))
...
play_btn = Button(play_img, False, 145, 260)
sound_btn = Button(sound_on_img, False, 154, 310)
restart_btn = Button(restart_img, False, 145, 260)
menu_btn = Button(menu_img, False, 145, 310)
...
for level in range(MAX_LEVEL):
	...
	r = level // 3
	c = level % 3
	btn = LevelButton(level_locked_img, (80, 80), 40 + c * 110, 100 + r * 110, text)
...
while running:
	...
	if game_page:
		...
		# Drawing info bar
		pygame.draw.rect(win, (25, 25, 25), (0, HEIGHT-40, WIDTH, 20))
